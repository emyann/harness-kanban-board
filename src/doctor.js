...
import { L, STATUSES, SAFE_BUILTINS, capabilityGrants, effectiveTools, agentsOf, compareVersions, mergePolicy, mergeGate, mergeGateFix, uncoveredBuiltins, kbVarsIn, pathOverlapGuard, unfinishedChildren, branchTaskNumber, denialDisplayTool, DENIAL_KINDS } from './model.js';
