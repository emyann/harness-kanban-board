...
export type BoardWhereInput = {
  ...
  repoPath?: Prisma.StringNullableFilter<"Board"> | string | null
  pausedAt?: Prisma.DateTimeNullableFilter<"Board"> | Date | string | null
  ...
  defaultBase?: Prisma.StringNullableFilter<"Board"> | string | null
  defaultCheck?: Prisma.StringNullableFilter<"Board"> | string | null
  defaultWorkflow?: Prisma.StringNullableFilter<"Board"> | string | null
...
export type BoardOrderByWithRelationInput = {
  ...
  repoPath?: Prisma.SortOrderInput | Prisma.SortOrder
  ...
  defaultBase?: Prisma.SortOrderInput | Prisma.SortOrder
  defaultCheck?: Prisma.SortOrderInput | Prisma.SortOrder
  defaultWorkflow?: Prisma.SortOrderInput | Prisma.SortOrder
...
export type BoardScalarWhereWithAggregatesInput = {
  ...
  repoPath?: Prisma.StringNullableWithAggregatesFilter<"Board"> | string | null
  pausedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"Board"> | Date | string | null
  ...
  defaultBase?: Prisma.StringNullableWithAggregatesFilter<"Board"> | string | null
  defaultCheck?: Prisma.StringNullableWithAggregatesFilter<"Board"> | string | null
  defaultWorkflow?: Prisma.StringNullableWithAggregatesFilter<"Board"> | string | null
...
export type BoardUpdateInput = {
  ...
  defaultBase?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
...
export type BoardCountOrderByAggregateInput = {
  ...
  defaultBase?: Prisma.SortOrder
  defaultCheck?: Prisma.SortOrder
  defaultWorkflow?: Prisma.SortOrder
  createdAt?: Prisma.SortOrder
  updatedAt?: Prisma.SortOrder
}
...
export type BoardCreateNestedOneWithoutControllerInput = {
  create?: Prisma.XOR<Prisma.BoardCreateWithoutControllerInput, Prisma.BoardUncheckedCreateWithoutControllerInput>
  connectOrCreate?: Prisma.BoardCreateOrConnectWithoutControllerInput
  connect?: Prisma.BoardWhereUniqueInput
}

export type BoardUpdateOneRequiredWithoutControllerNestedInput = {
  create?: Prisma.XOR<Prisma.BoardCreateWithoutControllerInput, Prisma.BoardUncheckedCreateWithoutControllerInput>
  connectOrCreate?: Prisma.BoardCreateOrConnectWithoutControllerInput
  upsert?: Prisma.BoardUpsertWithoutControllerInput
  connect?: Prisma.BoardWhereUniqueInput
  update?: Prisma.XOR<Prisma.XOR<Prisma.BoardUpdateToOneWithWhereWithoutControllerInput, Prisma.BoardUpdateWithoutControllerInput>, Prisma.BoardUncheckedUpdateWithoutControllerInput>
}
...
export type BoardUncheckedCreateWithoutControllerInput = {
  id?: number
  slug: string
  repoPath?: string | null
  pausedAt?: Date | string | null
...
export type BoardCreateOrConnectWithoutControllerInput = {
  where: Prisma.BoardWhereUniqueInput
  create: Prisma.XOR<Prisma.BoardCreateWithoutControllerInput, Prisma.BoardUncheckedCreateWithoutControllerInput>
}

export type BoardUpsertWithoutControllerInput = {
  update: Prisma.XOR<Prisma.BoardUpdateWithoutControllerInput, Prisma.BoardUncheckedUpdateWithoutControllerInput>
  create: Prisma.XOR<Prisma.BoardCreateWithoutControllerInput, Prisma.BoardUncheckedCreateWithoutControllerInput>
  where?: Prisma.BoardWhereInput
}

export type BoardUpdateToOneWithWhereWithoutControllerInput = {
  where?: Prisma.BoardWhereInput
  data: Prisma.XOR<Prisma.BoardUpdateWithoutControllerInput, Prisma.BoardUncheckedUpdateWithoutControllerInput>
}

export type BoardUpdateWithoutControllerInput = {
  slug?: Prisma.StringFieldUpdateOperationsInput | string
  repoPath?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
  pausedAt?: Prisma.NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  pausedBy?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
...
export type BoardUncheckedUpdateWithoutControllerInput = {
  id?: Prisma.IntFieldUpdateOperationsInput | number
  slug?: Prisma.StringFieldUpdateOperationsInput | string
  repoPath?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
  pausedAt?: Prisma.NullableDateTimeFieldUpdateOperationsInput | Date | string | null
...
export type $BoardPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  scalars: runtime.Types.Extensions.GetPayloadResult<{
    ...
    slug: string
    /**
     * The repository this board's Jobs run in, as an absolute path on this machine.
     * 
     * It lives here rather than on the Job because a Job is inherently single-repo — one worktree,
     * one branch, one pull request — and because a Board is the Namespace: the ceilings below are
     * already per-repo facts ("this repo's PR workflows are expensive, run one at a time"). Two
     * boards may share a repo if they want different budgets for different work.
     * 
     * Nullable so a board can exist before it is pointed at anything, and so tests can supply a
     * checkout directly. A Job on a board with no repoPath falls back to the caller's cwd.
     */
    repoPath: string | null
    /**
     ...
     * It is charged against what running work *could* cost, in-flight attempts included, so that a
     * board running several Jobs at once cannot commit its ceiling several times over.
     */
    dailyBudgetUsd: number | null
    /**
     ...
     * which model that work wants, and saying so once beats `--model` on every `kb new`. What keeps
     * them separate columns rather than one is that a ceiling and a default are opposites in who
    ...
    defaultMaxRetries: number | null
    /**
     * The board's default tool surface, filling a Job that named none. A default, not a ceiling:
     * a Job may name a *wider* list and get it. The ceiling a Job cannot exceed is
     * `dailyBudgetUsd`/`maxConcurrent` in `src/limits.ts`; this is `src/spec.ts` territory.
     */
    defaultAllowedTools: runtime.JsonValue | null
    /**
     * The board's plugin grants, filling a null on the Job the way every other default does
     * (`src/spec.ts`). Board-wide is the common case — "every Job on this repository may see its
    ...
    defaultGuide: string | null
    /**
     * The ref this board's Jobs branch from, filling a null on the Job. For a repository whose
     * trunk is not what `origin/HEAD` points at — a protected `main` with an integration branch in
     * front of it is the case that exists. Null keeps the repository's own default branch.
     */
    defaultBase: string | null
    /**
     * The completion check every Job on this board runs unless it says otherwise (`Job.check`
     * wins). One `hkb boards set <slug> --check "npm test"` is how a repository's own gate reaches
     * every worker on it. Null — the shipped default — means nothing runs.
     */
    defaultCheck: string | null
    /**
     * The name of a workflow in `.hkb/workflows/` — how work on this board FINISHES.
     * 
     * ADR-017 decision 1: a board's default workflow is a file, not code. The core tells a worker the
     * sandbox contract and nothing else, so "push and open a pull request" has to come from
     * somewhere, and a hand-filed Job (`hkb new --brief …`, no `--from`) had nowhere to get it. This
     * is that somewhere.
     * 
     * It composes differently from every other default here, and deliberately: the frontmatter fills
     * spec nulls the way `--from` would, and the BODY is appended to the brief as standing steps
     * (`src/templates.ts`). A Job filed WITH `--from` ignores it entirely — that workflow governs.
     * Null, the shipped default, means a Job gets the sandbox contract and nothing else.
     */
    defaultWorkflow: string | null
    createdAt: Date
    updatedAt: Date
...
export interface BoardFieldRefs {
  ...
  readonly repoPath: Prisma.FieldRef<"Board", 'String'>
  readonly pausedAt: Prisma.FieldRef<"Board", 'DateTime'>
  ...
  readonly defaultBase: Prisma.FieldRef<"Board", 'String'>
  readonly defaultCheck: Prisma.FieldRef<"Board", 'String'>
  readonly defaultWorkflow: Prisma.FieldRef<"Board", 'String'>
 ...
 * Board.controller
 */
export type Board$controllerArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
