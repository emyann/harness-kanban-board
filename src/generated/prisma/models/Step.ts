...
export type StepWhereInput = {
  ...
  runId?: Prisma.IntFilter<"Step"> | number
  name?: Prisma.StringFilter<"Step"> | string
  after?: Prisma.JsonFilter<"Step">
...
export type StepWhereUniqueInput = Prisma.AtLeast<{
  id?: number
  runId_name?: Prisma.StepRunIdNameCompoundUniqueInput
  AND?: Prisma.StepWhereInput | Prisma.StepWhereInput[]
  OR?: Prisma.StepWhereInput[]
  NOT?: Prisma.StepWhereInput | Prisma.StepWhereInput[]
  runId?: Prisma.IntFilter<"Step"> | number
...
export type StepScalarWhereWithAggregatesInput = {
  ...
  runId?: Prisma.IntWithAggregatesFilter<"Step"> | number
  name?: Prisma.StringWithAggregatesFilter<"Step"> | string
  after?: Prisma.JsonWithAggregatesFilter<"Step">
}
...
export type StepCreateInput = {
  ...
  job?: Prisma.JobCreateNestedOneWithoutStepInput
}
...
export type StepUncheckedCreateInput = {
  ...
  name: string
  after?: Prisma.JsonNullValueInput | runtime.InputJsonValue
  job?: Prisma.JobUncheckedCreateNestedOneWithoutStepInput
}
...
export type StepUpdateInput = {
  ...
  job?: Prisma.JobUpdateOneWithoutStepNestedInput
}
...
export type StepUncheckedUpdateInput = {
  ...
  name?: Prisma.StringFieldUpdateOperationsInput | string
  after?: Prisma.JsonNullValueInput | runtime.InputJsonValue
  job?: Prisma.JobUncheckedUpdateOneWithoutStepNestedInput
}
...
export type StepRunIdNameCompoundUniqueInput = {
  runId: number
  name: string
}
...
export type StepCreateNestedOneWithoutJobInput = {
  create?: Prisma.XOR<Prisma.StepCreateWithoutJobInput, Prisma.StepUncheckedCreateWithoutJobInput>
  connectOrCreate?: Prisma.StepCreateOrConnectWithoutJobInput
  connect?: Prisma.StepWhereUniqueInput
}

export type StepUpdateOneWithoutJobNestedInput = {
  create?: Prisma.XOR<Prisma.StepCreateWithoutJobInput, Prisma.StepUncheckedCreateWithoutJobInput>
  connectOrCreate?: Prisma.StepCreateOrConnectWithoutJobInput
  upsert?: Prisma.StepUpsertWithoutJobInput
  disconnect?: Prisma.StepWhereInput | boolean
  delete?: Prisma.StepWhereInput | boolean
  connect?: Prisma.StepWhereUniqueInput
  update?: Prisma.XOR<Prisma.XOR<Prisma.StepUpdateToOneWithWhereWithoutJobInput, Prisma.StepUpdateWithoutJobInput>, Prisma.StepUncheckedUpdateWithoutJobInput>
}
...
export type StepUncheckedCreateWithoutJobInput = {
  id?: number
  runId: number
  name: string
  after?: Prisma.JsonNullValueInput | runtime.InputJsonValue
...
export type StepCreateOrConnectWithoutJobInput = {
  where: Prisma.StepWhereUniqueInput
  create: Prisma.XOR<Prisma.StepCreateWithoutJobInput, Prisma.StepUncheckedCreateWithoutJobInput>
}

export type StepUpsertWithoutJobInput = {
  update: Prisma.XOR<Prisma.StepUpdateWithoutJobInput, Prisma.StepUncheckedUpdateWithoutJobInput>
  create: Prisma.XOR<Prisma.StepCreateWithoutJobInput, Prisma.StepUncheckedCreateWithoutJobInput>
  where?: Prisma.StepWhereInput
}

export type StepUpdateToOneWithWhereWithoutJobInput = {
  where?: Prisma.StepWhereInput
  data: Prisma.XOR<Prisma.StepUpdateWithoutJobInput, Prisma.StepUncheckedUpdateWithoutJobInput>
}

export type StepUpdateWithoutJobInput = {
  name?: Prisma.StringFieldUpdateOperationsInput | string
  after?: Prisma.JsonNullValueInput | runtime.InputJsonValue
  run?: Prisma.RunUpdateOneRequiredWithoutStepsNestedInput
}

export type StepUncheckedUpdateWithoutJobInput = {
  id?: Prisma.IntFieldUpdateOperationsInput | number
  runId?: Prisma.IntFieldUpdateOperationsInput | number
  name?: Prisma.StringFieldUpdateOperationsInput | string
  after?: Prisma.JsonNullValueInput | runtime.InputJsonValue
...
export type StepSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
  ...
  job?: boolean | Prisma.Step$jobArgs<ExtArgs>
}, ExtArgs["result"]["step"]>
...
export type StepOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "runId" | "name" | "after", ExtArgs["result"]["step"]>
...
export type $StepPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  objects: {
    ...
    /**
     * The Job carrying this step out, by the owner reference on the Job itself. Null while it has
     * not been filed, which is the gap `reconcileRuns` acts on.
     */
  ...
  scalars: runtime.Types.Extensions.GetPayloadResult<{
    ...
    runId: number
    /**
     * The workflow this step runs: `.hkb/workflows/<name>.md`, read at file time and gone.
     * 
     * Unique within the run because `after` names siblings by name rather than by id — the ids do
     * not exist when the run is cut. This is exactly why `Job.after` was the wrong shape and this one
     * is not (`docs/workflow-study.md` §2): a name is ambiguous globally and precise inside an owner.
     */
    name: string
    /**
     * The names of the sibling steps that must succeed first. `[]` — the default — is ready at once,
     * so the first step of a run needs no special case anywhere.
     * 
     * **The only column any reconcile pass reads on every pass**, which is what earns it a column at
     * all. `batch/v1` has nothing like it; Tekton's `PipelineTask.runAfter` is the analogue, and it
     * lives in a separate API group with a separate controller for the same reason this does.
     */
    after: runtime.JsonValue
  }, ExtArgs["result"]["step"]>
  composites: {}
...
export interface Prisma__StepClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
  ...
  job<T extends Prisma.Step$jobArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.Step$jobArgs<ExtArgs>>): Prisma.Prisma__JobClient<runtime.Types.Result.GetResult<Prisma.$JobPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>
  /**
...
export interface StepFieldRefs {
  ...
  readonly runId: Prisma.FieldRef<"Step", 'Int'>
  readonly name: Prisma.FieldRef<"Step", 'String'>
  readonly after: Prisma.FieldRef<"Step", 'Json'>
}
 ...
 * Step.job
 */
export type Step$jobArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
